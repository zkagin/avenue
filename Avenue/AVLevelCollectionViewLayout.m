...
- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    NSArray<UICollectionViewLayoutAttributes *> *newAttributes =
        [[NSArray alloc] initWithArray:originalAttributes copyItems:YES];
                                 ...
                                 withScrollingVelocity:(CGPoint)velocity
{
    ...
    CGRect targetRect =
        CGRectMake(proposedContentOffset.x, 0, self.collectionView.bounds.size.width, self.collectionView.bounds.size.height);
